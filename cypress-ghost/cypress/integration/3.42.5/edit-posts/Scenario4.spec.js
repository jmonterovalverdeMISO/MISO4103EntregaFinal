...
context("Edit scheduled post", () => {
  ...
  it("should navigate to last published post", () => {
    PostListPage.getLastScheduledPostTitle().click({ force: true });
  ...
  it("should update and reschedule post", () => {
    PostsPage.getPublishButton().click();

    PostsPage.getPublishButton().should("contain.text", "Rescheduled");
  });
});
